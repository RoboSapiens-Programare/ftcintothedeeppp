...
public class UniversalValues {
    ...
    public static double INTAKE_UP = 0.715;
    public static double INTAKE_DOWN = 0.125;
    public static double INTAKE_INT = 0.5;
    public static double INTAKE_INIT = 0.922;
    ...
    public static double CLAW_LOOSE = 0.195;
    ...
    public static double OUTTAKE_COLLECT_NEW_TRANSFER = 0.365;
